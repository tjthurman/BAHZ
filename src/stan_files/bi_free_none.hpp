...
namespace model_bi_free_none_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bi_free_none");
    ...
    reader.add_event(14, 1, "restart", "model_bi_free_none");
    ...
    reader.add_event(23, 5, "restart", "model_bi_free_none");
...
#include <meta_header.hpp>
 class model_bi_free_none : public prob_grad {
private:
    int N;
    ...
    double p_max_2;
public:
    model_bi_free_none(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bi_free_none_namespace::model_bi_free_none";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bi_free_none_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bi_free_none_namespace::model_bi_free_none stan_model;
