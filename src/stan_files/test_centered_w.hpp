...
namespace model_test_centered_w_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_test_centered_w");
    ...
    reader.add_event(14, 1, "restart", "model_test_centered_w");
    reader.add_event(68, 53, "end", "model_test_centered_w");
    return reader;
}

#include <meta_header.hpp>
 class model_test_centered_w : public prob_grad {
private:
    int N;
...
public:
    model_test_centered_w(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_test_centered_w_namespace::model_test_centered_w";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(center, 0, 150));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(p, 
                            ...
                            (pmin + ((pmax - pmin) * (stan::math::exp((width * (get_base1(transectDist,i,"transectDist",1) - center))) / (1 + stan::math::exp((width * (get_base1(transectDist,i,"transectDist",1) - center))))))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_test_centered_w_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_test_centered_w_namespace::model_test_centered_w stan_model;
