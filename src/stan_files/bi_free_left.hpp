...
namespace model_bi_free_left_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bi_free_left");
    ...
    reader.add_event(14, 1, "restart", "model_bi_free_left");
    ...
    reader.add_event(23, 5, "restart", "model_bi_free_left");
    ...
    reader.add_event(33, 6, "restart", "model_bi_free_left");
    reader.add_event(33, 6, "include", "/priors/priors_left_tail.stan");
    reader.add_event(33, 0, "start", "/priors/priors_left_tail.stan");
    reader.add_event(37, 4, "end", "/priors/priors_left_tail.stan");
    reader.add_event(37, 7, "restart", "model_bi_free_left");
    ...
    reader.add_event(46, 13, "restart", "model_bi_free_left");
    reader.add_event(46, 13, "include", "/parameters/param_left_tail.stan");
    reader.add_event(46, 0, "start", "/parameters/param_left_tail.stan");
    reader.add_event(48, 2, "end", "/parameters/param_left_tail.stan");
    reader.add_event(48, 14, "restart", "model_bi_free_left");
    reader.add_event(78, 44, "include", "/model/model_left_tail.stan");
    reader.add_event(78, 0, "start", "/model/model_left_tail.stan");
    reader.add_event(80, 2, "end", "/model/model_left_tail.stan");
    reader.add_event(80, 45, "restart", "model_bi_free_left");
    reader.add_event(80, 45, "include", "/model/model_ps.stan");
    reader.add_event(80, 0, "start", "/model/model_ps.stan");
    reader.add_event(82, 2, "end", "/model/model_ps.stan");
    reader.add_event(82, 46, "restart", "model_bi_free_left");
    reader.add_event(82, 46, "include", "/model/model_width.stan");
    reader.add_event(82, 0, "start", "/model/model_width.stan");
    reader.add_event(88, 6, "end", "/model/model_width.stan");
    reader.add_event(88, 47, "restart", "model_bi_free_left");
    reader.add_event(88, 47, "include", "/model/model_center.stan");
    reader.add_event(88, 0, "start", "/model/model_center.stan");
    reader.add_event(94, 6, "end", "/model/model_center.stan");
    reader.add_event(94, 48, "restart", "model_bi_free_left");
    reader.add_event(101, 55, "include", "/generated_quantities/gen_quant_binomial.stan");
    reader.add_event(101, 0, "start", "/generated_quantities/gen_quant_binomial.stan");
    reader.add_event(113, 12, "end", "/generated_quantities/gen_quant_binomial.stan");
    reader.add_event(113, 56, "restart", "model_bi_free_left");
    reader.add_event(117, 58, "end", "model_bi_free_left");
    return reader;
}

#include <meta_header.hpp>
 class model_bi_free_left : public prob_grad {
private:
    int N;
    ...
    double p_deltaL_2;
public:
    model_bi_free_left(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bi_free_left_namespace::model_bi_free_left";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "p_tauL_1", "double", context__.to_vec());
            p_tauL_1 = double(0);
            vals_r__ = context__.vals_r("p_tauL_1");
            pos__ = 0;
            p_tauL_1 = vals_r__[pos__++];
            current_statement_begin__ = 35;
            context__.validate_dims("data initialization", "p_tauL_2", "double", context__.to_vec());
            p_tauL_2 = double(0);
            vals_r__ = context__.vals_r("p_tauL_2");
            pos__ = 0;
            p_tauL_2 = vals_r__[pos__++];
            current_statement_begin__ = 36;
            context__.validate_dims("data initialization", "p_deltaL_1", "double", context__.to_vec());
            p_deltaL_1 = double(0);
            vals_r__ = context__.vals_r("p_deltaL_1");
            pos__ = 0;
            p_deltaL_1 = vals_r__[pos__++];
            current_statement_begin__ = 37;
            context__.validate_dims("data initialization", "p_deltaL_2", "double", context__.to_vec());
            p_deltaL_2 = double(0);
            vals_r__ = context__.vals_r("p_deltaL_2");
            pos__ = 0;
            p_deltaL_2 = vals_r__[pos__++];
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("deltaL")))
            throw std::runtime_error("variable deltaL missing");
        vals_r__ = context__.vals_r("deltaL");
        pos__ = 0U;
        context__.validate_dims("initialization", "deltaL", "double", context__.to_vec());
        double deltaL(0);
        deltaL = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,deltaL);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable deltaL: ") + e.what());
        }

        if (!(context__.contains_r("tauL")))
            throw std::runtime_error("variable tauL missing");
        vals_r__ = context__.vals_r("tauL");
        pos__ = 0U;
        context__.validate_dims("initialization", "tauL", "double", context__.to_vec());
        double tauL(0);
        tauL = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0,1,tauL);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable tauL: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            local_scalar_t__ deltaL;
            (void) deltaL;  // dummy to suppress unused var warning
            if (jacobian__)
                deltaL = in__.scalar_lb_constrain(0,lp__);
            else
                deltaL = in__.scalar_lb_constrain(0);

            local_scalar_t__ tauL;
            (void) tauL;  // dummy to suppress unused var warning
            if (jacobian__)
                tauL = in__.scalar_lub_constrain(0,1,lp__);
            else
                tauL = in__.scalar_lub_constrain(0,1);
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("deltaL");
        names__.push_back("tauL");
        names__.push_back("p");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bi_free_left_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double deltaL = in__.scalar_lb_constrain(0);
        double tauL = in__.scalar_lub_constrain(0,1);
        vars__.push_back(center);
        vars__.push_back(width);
        vars__.push_back(pmin);
        vars__.push_back(pmax);
        vars__.push_back(deltaL);
        vars__.push_back(tauL);
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "deltaL";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "tauL";
        param_names__.push_back(param_name_stream__.str());
...
typedef model_bi_free_left_namespace::model_bi_free_left stan_model;
