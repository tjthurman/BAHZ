...
namespace model_bi_free_mirror_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bi_free_mirror");
    ...
    reader.add_event(14, 1, "restart", "model_bi_free_mirror");
    reader.add_event(17, 4, "include", "/data/data_binom.stan");
    reader.add_event(17, 0, "start", "/data/data_binom.stan");
    reader.add_event(23, 6, "end", "/data/data_binom.stan");
    reader.add_event(23, 5, "restart", "model_bi_free_mirror");
    reader.add_event(23, 5, "include", "/priors/priors_all.stan");
    reader.add_event(23, 0, "start", "/priors/priors_all.stan");
    reader.add_event(33, 10, "end", "/priors/priors_all.stan");
    reader.add_event(33, 6, "restart", "model_bi_free_mirror");
    reader.add_event(33, 6, "include", "/priors/priors_mirror_tail.stan");
    reader.add_event(33, 0, "start", "/priors/priors_mirror_tail.stan");
    reader.add_event(37, 4, "end", "/priors/priors_mirror_tail.stan");
    reader.add_event(37, 7, "restart", "model_bi_free_mirror");
    reader.add_event(42, 12, "include", "/parameters/param_all.stan");
    reader.add_event(42, 0, "start", "/parameters/param_all.stan");
    reader.add_event(46, 4, "end", "/parameters/param_all.stan");
    reader.add_event(46, 13, "restart", "model_bi_free_mirror");
    reader.add_event(46, 13, "include", "/parameters/param_mirror_tail.stan");
    reader.add_event(46, 0, "start", "/parameters/param_mirror_tail.stan");
    reader.add_event(48, 2, "end", "/parameters/param_mirror_tail.stan");
    reader.add_event(48, 14, "restart", "model_bi_free_mirror");
    reader.add_event(86, 52, "include", "/model/model_mirror_tail.stan");
    reader.add_event(86, 0, "start", "/model/model_mirror_tail.stan");
    reader.add_event(88, 2, "end", "/model/model_mirror_tail.stan");
    reader.add_event(88, 53, "restart", "model_bi_free_mirror");
    reader.add_event(88, 53, "include", "/model/model_ps.stan");
    reader.add_event(88, 0, "start", "/model/model_ps.stan");
    reader.add_event(90, 2, "end", "/model/model_ps.stan");
    reader.add_event(90, 54, "restart", "model_bi_free_mirror");
    reader.add_event(90, 54, "include", "/model/model_width.stan");
    reader.add_event(90, 0, "start", "/model/model_width.stan");
    reader.add_event(96, 6, "end", "/model/model_width.stan");
    reader.add_event(96, 55, "restart", "model_bi_free_mirror");
    reader.add_event(96, 55, "include", "/model/model_center.stan");
    reader.add_event(96, 0, "start", "/model/model_center.stan");
    reader.add_event(102, 6, "end", "/model/model_center.stan");
    reader.add_event(102, 56, "restart", "model_bi_free_mirror");
    reader.add_event(109, 63, "include", "/generated_quantities/gen_quant_binomial.stan");
    reader.add_event(109, 0, "start", "/generated_quantities/gen_quant_binomial.stan");
    reader.add_event(121, 12, "end", "/generated_quantities/gen_quant_binomial.stan");
    reader.add_event(121, 64, "restart", "model_bi_free_mirror");
    reader.add_event(125, 66, "end", "model_bi_free_mirror");
    return reader;
}

#include <meta_header.hpp>
 class model_bi_free_mirror : public prob_grad {
private:
    int N;
    ...
    double p_deltaM_2;
public:
    model_bi_free_mirror(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bi_free_mirror_namespace::model_bi_free_mirror";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "p_dist_width", "int", context__.to_vec());
            p_dist_width = int(0);
            vals_i__ = context__.vals_i("p_dist_width");
            pos__ = 0;
            p_dist_width = vals_i__[pos__++];
            ...
            context__.validate_dims("data initialization", "p_tauM_1", "double", context__.to_vec());
            p_tauM_1 = double(0);
            vals_r__ = context__.vals_r("p_tauM_1");
            pos__ = 0;
            p_tauM_1 = vals_r__[pos__++];
            current_statement_begin__ = 35;
            context__.validate_dims("data initialization", "p_tauM_2", "double", context__.to_vec());
            p_tauM_2 = double(0);
            vals_r__ = context__.vals_r("p_tauM_2");
            pos__ = 0;
            p_tauM_2 = vals_r__[pos__++];
            current_statement_begin__ = 36;
            context__.validate_dims("data initialization", "p_deltaM_1", "double", context__.to_vec());
            p_deltaM_1 = double(0);
            vals_r__ = context__.vals_r("p_deltaM_1");
            pos__ = 0;
            p_deltaM_1 = vals_r__[pos__++];
            current_statement_begin__ = 37;
            context__.validate_dims("data initialization", "p_deltaM_2", "double", context__.to_vec());
            p_deltaM_2 = double(0);
            vals_r__ = context__.vals_r("p_deltaM_2");
            pos__ = 0;
            p_deltaM_2 = vals_r__[pos__++];
            ...
            current_statement_begin__ = 25;
            check_less_or_equal(function__,"p_dist_width",p_dist_width,1);
            current_statement_begin__ = 26;
            current_statement_begin__ = 27;
            current_statement_begin__ = 28;
            current_statement_begin__ = 29;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("deltaM")))
            throw std::runtime_error("variable deltaM missing");
        vals_r__ = context__.vals_r("deltaM");
        pos__ = 0U;
        context__.validate_dims("initialization", "deltaM", "double", context__.to_vec());
        double deltaM(0);
        deltaM = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0,deltaM);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable deltaM: ") + e.what());
        }

        if (!(context__.contains_r("tauM")))
            throw std::runtime_error("variable tauM missing");
        vals_r__ = context__.vals_r("tauM");
        pos__ = 0U;
        context__.validate_dims("initialization", "tauM", "double", context__.to_vec());
        double tauM(0);
        tauM = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0,1,tauM);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable tauM: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                tauM = in__.scalar_lub_constrain(0,1,lp__);
            else
                tauM = in__.scalar_lub_constrain(0,1);
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_lte(get_base1(transectDist,i,"transectDist",1),(center - deltaM)))) {
                    ...
                    if (as_bool(logical_eq(decrease,0))) {
                        ...
                        stan::model::assign(p, 
                                    ...
                                    (pmin + (((pmax - pmin) * (1 / (1 + stan::math::exp(((4 * deltaM) / width))))) * stan::math::exp(((((4 * tauM) * ((get_base1(transectDist,i,"transectDist",1) - center) + deltaM)) / width) / (1 + stan::math::exp(((-(4) * deltaM) / width))))))), 
                    ...
                    if (as_bool(logical_eq(decrease,1))) {
                        ...
                        stan::model::assign(p, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    (pmin + ((pmax - pmin) * (1 - ((1 / (1 + stan::math::exp(((4 * deltaM) / width)))) * stan::math::exp(((((4 * tauM) * ((get_base1(transectDist,i,"transectDist",1) - center) + deltaM)) / width) / (1 + stan::math::exp(((-(4) * deltaM) / width))))))))), 
                                    "assigning variable p");
                    }
                } else if (as_bool(logical_gte(get_base1(transectDist,i,"transectDist",1),(center + deltaM)))) {
            ...
            lp_accum__.add(uniform_log<propto__>(tauM, p_tauM_1, p_tauM_2));
            current_statement_begin__ = 88;
            lp_accum__.add(exponential_log<propto__>(deltaM, p_deltaM_1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_bi_free_mirror_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double tauM = in__.scalar_lub_constrain(0,1);
...
typedef model_bi_free_mirror_namespace::model_bi_free_mirror stan_model;
