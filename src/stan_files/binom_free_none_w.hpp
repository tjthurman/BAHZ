...
namespace model_binom_free_none_w_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_binom_free_none_w");
    ...
    reader.add_event(14, 1, "restart", "model_binom_free_none_w");
    ...
    reader.add_event(28, 10, "restart", "model_binom_free_none_w");
    ...
    reader.add_event(38, 12, "restart", "model_binom_free_none_w");
    reader.add_event(87, 59, "end", "model_binom_free_none_w");
    return reader;
}

#include <meta_header.hpp>
 class model_binom_free_none_w : public prob_grad {
private:
    int N;
    ...
    double p_u_max;
public:
    model_binom_free_none_w(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_binom_free_none_w_namespace::model_binom_free_none_w";
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(decrease,1))) {
                    ...
                    stan::model::assign(p, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (pmin + ((pmax - pmin) * (1 - (stan::math::exp((w * (get_base1(transectDist,i,"transectDist",1) - center))) / (1 + stan::math::exp((w * (get_base1(transectDist,i,"transectDist",1) - center)))))))), 
                                "assigning variable p");
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_binom_free_none_w_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_binom_free_none_w";
    }
...
typedef model_binom_free_none_w_namespace::model_binom_free_none_w stan_model;
