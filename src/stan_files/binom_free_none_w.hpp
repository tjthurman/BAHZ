...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(39, 10, "end", "/priors/priors_binom.stan");
    reader.add_event(39, 12, "restart", "model_binom_free_none_w");
    reader.add_event(88, 59, "end", "model_binom_free_none_w");
    return reader;
}
