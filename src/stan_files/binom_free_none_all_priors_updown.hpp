...
namespace model_binom_free_none_all_priors_updown_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_binom_free_none_all_priors_updown");
    ...
    reader.add_event(14, 1, "restart", "model_binom_free_none_all_priors_updown");
    reader.add_event(20, 7, "include", "/data_and_priors_binom_updown.stan");
    reader.add_event(20, 0, "start", "/data_and_priors_binom_updown.stan");
    reader.add_event(35, 15, "end", "/data_and_priors_binom_updown.stan");
    reader.add_event(35, 8, "restart", "model_binom_free_none_all_priors_updown");
    reader.add_event(82, 53, "end", "model_binom_free_none_all_priors_updown");
    return reader;
}

#include <meta_header.hpp>
 class model_binom_free_none_all_priors_updown : public prob_grad {
private:
    int N;
    ...
    int desc;
public:
    model_binom_free_none_all_priors_updown(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_binom_free_none_all_priors_updown_namespace::model_binom_free_none_all_priors_updown";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "p_m_center", "double", context__.to_vec());
            p_m_center = double(0);
            vals_r__ = context__.vals_r("p_m_center");
            pos__ = 0;
            p_m_center = vals_r__[pos__++];
            current_statement_begin__ = 27;
            context__.validate_dims("data initialization", "p_sd_center", "double", context__.to_vec());
            p_sd_center = double(0);
            vals_r__ = context__.vals_r("p_sd_center");
            pos__ = 0;
            p_sd_center = vals_r__[pos__++];
            current_statement_begin__ = 28;
            context__.validate_dims("data initialization", "p_m_width", "double", context__.to_vec());
            p_m_width = double(0);
            vals_r__ = context__.vals_r("p_m_width");
            pos__ = 0;
            p_m_width = vals_r__[pos__++];
            current_statement_begin__ = 29;
            context__.validate_dims("data initialization", "p_sd_width", "double", context__.to_vec());
            p_sd_width = double(0);
            vals_r__ = context__.vals_r("p_sd_width");
            pos__ = 0;
            ...
            pos__ = 0;
            p_u_max = vals_r__[pos__++];
            current_statement_begin__ = 34;
            context__.validate_dims("data initialization", "desc", "int", context__.to_vec());
            desc = int(0);
            vals_i__ = context__.vals_i("desc");
            pos__ = 0;
            desc = vals_i__[pos__++];
            ...
            current_statement_begin__ = 33;
            current_statement_begin__ = 34;
            check_greater_or_equal(function__,"desc",desc,0);
            check_less_or_equal(function__,"desc",desc,1);
    ...
    ~model_binom_free_none_all_priors_updown() { }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(uniform_log<propto__>(pmax, p_l_max, p_u_max));
            current_statement_begin__ = 60;
            lp_accum__.add(uniform_log<propto__>(pmin, p_l_min, p_u_min));
            current_statement_begin__ = 61;
            lp_accum__.add(normal_log<propto__>(width, p_m_width, p_sd_width));
            current_statement_begin__ = 62;
            lp_accum__.add(normal_log<propto__>(center, p_m_center, p_sd_center));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_binom_free_none_all_priors_updown_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_binom_free_none_all_priors_updown";
    }
...
typedef model_binom_free_none_all_priors_updown_namespace::model_binom_free_none_all_priors_updown stan_model;
