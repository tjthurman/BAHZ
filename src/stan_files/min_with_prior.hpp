...
namespace model_min_with_prior_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_min_with_prior");
    reader.add_event(47, 45, "end", "model_min_with_prior");
    return reader;
}

#include <meta_header.hpp>
 class model_min_with_prior : public prob_grad {
private:
    int N;
...
public:
    model_min_with_prior(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_min_with_prior_namespace::model_min_with_prior";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_min_with_prior_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_min_with_prior_namespace::model_min_with_prior stan_model;
