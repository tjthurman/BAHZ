...
namespace model_binom_free_none_all_priors_w_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_binom_free_none_all_priors_w");
    ...
    reader.add_event(14, 1, "restart", "model_binom_free_none_all_priors_w");
    reader.add_event(20, 7, "include", "/data_and_priors_binom.stan");
    reader.add_event(20, 0, "start", "/data_and_priors_binom.stan");
    reader.add_event(35, 15, "end", "/data_and_priors_binom.stan");
    reader.add_event(35, 8, "restart", "model_binom_free_none_all_priors_w");
    reader.add_event(78, 49, "end", "model_binom_free_none_all_priors_w");
    return reader;
}

#include <meta_header.hpp>
 class model_binom_free_none_all_priors_w : public prob_grad {
private:
    int N;
    ...
    double p_u_max;
public:
    model_binom_free_none_all_priors_w(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_binom_free_none_all_priors_w_namespace::model_binom_free_none_all_priors_w";
    ...
    ~model_binom_free_none_all_priors_w() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("initialization", "w", "double", context__.to_vec());
        double w(0);
        w = vals_r__[pos__++];
        try {
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(p, 
                            ...
                            (pmin + ((pmax - pmin) * (stan::math::exp((w * (get_base1(transectDist,i,"transectDist",1) - center))) / (1 + stan::math::exp((w * (get_base1(transectDist,i,"transectDist",1) - center))))))), 
            ...
            lp_accum__.add(exponential_log<propto__>(w, p_scale_width));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_binom_free_none_all_priors_w_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "model_binom_free_none_all_priors_w";
    }
...
typedef model_binom_free_none_all_priors_w_namespace::model_binom_free_none_all_priors_w stan_model;
