...
namespace model_minimal_namespace {
...
#include <meta_header.hpp>
 class model_minimal : public prob_grad {
private:
    int N;
...
public:
    model_minimal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_minimal_namespace::model_minimal";
...
typedef model_minimal_namespace::model_minimal stan_model;
