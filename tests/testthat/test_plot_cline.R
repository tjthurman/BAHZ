...
test_that("plot_cline checks args for type", {
  ...
  expect_error(plot_cline(stanfit = ref_geno_stanfit,
                          data = a.ref, clear.cache = "XXX"), "TRUE")
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, prob = "x"), "numeric")
  expect_error(plot_cline(stanfit = ref_geno_stanfit,
...
test_that("plot_cline checks args for appropriateness", {
  # Prob is good
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, prob = c(0.6, 0.9)), "length")
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, prob = -.5), "between")
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, prob = 1.1), "between")
  # Colors are OK
  expect_error(plot_cline(stanfit = ref_geno_stanfit,
  ...
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, ann = "blue"), "default")
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, border = "blue"), "default")
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, col = "blue"), "default")
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, type = "p"), "default")
  expect_error(plot_cline(ref_geno_stanfit, data = a.ref, distance = 3, ylim = "blue"), "default")
})
