...
stanmodels <- c("bi", "multi", "pheno_constant", "pheno_independent", "pheno_pooled")

# load each stan module
Rcpp::loadModule("stan_fit4bi_mod", what = TRUE)
Rcpp::loadModule("stan_fit4multi_mod", what = TRUE)
